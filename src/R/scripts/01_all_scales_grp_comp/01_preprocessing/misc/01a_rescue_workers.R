# Script name: 01a_rescue_workers.R
# Project: Self compassione: one construct or two?
# Script purpose: script_purpose
# @author: Corrado Caudek <corrado.caudek@unifi.it>
# Date Created: Sat Apr  3 11:09:10 2021
# Last Modified Date: Mon Sep 26 14:46:36 2022
# 
# Notes: In the rescue workders group, the following scales have been 
# administered.
#
# - NEO FFI 60: 
...
# total score
cope_nvi_total_score <- social_support + avoiding_strategies + 
  positive_attitude + problem_orientation + 
  transcendent_orientation


mean(social_support, na.rm = TRUE)
# mean(avoiding_strategies, na.rm = TRUE)
mean(positive_attitude, na.rm = TRUE)
mean(problem_orientation, na.rm = TRUE)
# mean(transcendent_orientation, na.rm = TRUE)
mean(avoiding_strategies_R, na.rm = TRUE)
mean(transcendent_orientation_R, na.rm = TRUE)
