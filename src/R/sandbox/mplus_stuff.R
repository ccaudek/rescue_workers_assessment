...
# provo ad usare solo i dati 'puliti' che userò in SEM.
...
write.table(scs_rw, file="prova.dat", sep=" ", quote=FALSE, row.names = FALSE)



the_dir <- "/Users/corrado/Documents/papers/self_compassion/2022/scripts/_mplus_2022/"


d <- read.table(here("scripts", "_mplus", "scs.dat"), header = FALSE)

d <- rio::import(
  "/Users/corrado/Documents/papers/self_compassion/2022/data/self_compassion_scale.csv"
)
...
# Using data from 747 participants on the SCS.
prepareMplusData(d, paste0(the_dir, "selfcompassionitems.dat"))


prepareMplusData(d, paste0(the_dir, "prova.dat"))
...
model_results <- readModels(paste0(the_dir, "prova.out"),
                            quiet = TRUE)
