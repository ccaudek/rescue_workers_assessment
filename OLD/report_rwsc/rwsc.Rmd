...
Rescue workers (RWs) and healthcare workers (HCWs) are consistently confronted with the distress of others. While their proactive efforts to alleviate suffering can result in personal growth and Post-Traumatic Growth [PTG; @zoellner2006posttraumatic], it can also lead to "compassion fatigue" [@joinson1992coping], burn-out [ref], and post-traumatic stress [ref] when the demands of compassion exceed its restorative effects. It is therefore important to understand and promote the internal and external factors which support the resilience of RWs and HCWs [@mao2022concept].

In recent years, there has been a growing interest in the concept of the "self" as a crucial construct for improving our comprehension of individual differences in coping with stress [@beck2016self]. Self-compassion, which represents specific ways of interacting with oneself, has been found to have a positive impact on mental health [@macbeth2012exploring]. A compassionate mindset towards oneself has also been suggested to function as a protective factor against psychopathology such as Post-Traumatic Stress Disorder (PTSD), and to promote Post-Traumatic Growth (PTG) following traumatic events [@wilson2019effectiveness; @wong2017self]. 

The present study focuses on self-compassion as a coping mechanism in RWs. Specifically, the study aims to:

- Determine whether there is a significant difference in self-compassion between RWs and a control community sample.
- Explore individual differences in the capacity of RWs to rely on self-compassion and investigate how these individual differences relate to latent profiles of protective and risk factors for compassion fatigue and burn-out.
- Examine the relationship between self-efficacy, in the form of job qualification (direct vs indirect involvement in alleviating the suffering of others), and the ability to rely on self-compassion.

By addressing these research questions, the study aims to shed light on the role of self-compassion in RWs and its potential impact on their mental health and well-being.

## Self-compassion as protective factor

The construct of self-compassion is typically evaluated using the Self-Compassion Scale (SCS), which is a 26-item self-report questionnaire that encompasses six dimensions. Three of these dimensions - Self-kindness (SK), Common humanity (CH), and Mindfulness (MI) - assess the active components of self-compassion, which involve being kind and understanding towards oneself, recognizing that personal failures and pain are universal experiences, and maintaining a mindful awareness of one's painful thoughts and feelings. The remaining three dimensions - Self-judgment (SJ), Isolation (IS), and Overidentification (OI) - measure the "hindrances" that hinder self-compassion, such as being self-critical and unsympathetic towards one's shortcomings, isolating oneself from others, and over-identifying with one's painful thoughts and emotions [@neff2022differential].

Research suggests that individuals who experience compassion fatigue may tend to rely more on non-self-compassionate coping strategies compared to those who are less affected by compassion fatigue [@gonzalez2021volunteers]. Compassion fatigue often leads to a sense of helplessness and a feeling of being unable to do more to help others [@boyle2015compassion]. This learned helplessness may be more pronounced in individuals who are not directly involved in alleviating the suffering of others, such as ambulance drivers who only witness suffering but do not take action to alleviate it. This imbalance in learned helplessness may affect the use of self-compassionate responding (i.e., self-kindness, common humanity, mindfulness) versus uncompassionate responding (i.e., self-judgment, isolation, overidentification).
...
The aim of this study was to identify distinct profiles of rescue workers using latent variable analysis (LVA). LVA is a finite mixture modeling technique that partitions individuals into discrete classes based on their responses to observed variables (Roesch et al., 2010). This technique is particularly useful for identifying subgroups of individuals that can be meaningfully compared (Lanza & Rhoades, 2013). The primary objectives of LVA are twofold. Firstly, to ensure homogeneity within each identified profile so that individuals grouped together are as similar as possible. Secondly, to maximize heterogeneity between profiles so that each profile accurately represents a distinct grouping of individuals (Roesch et al., 2010). The classes generated by LVA are considered latent since they are not directly observable but are inferred based on similarities in the data (Roesch et al., 2010).
...
<!-- @neff2022differential proposes that the strengthening of the three proactive components of self-compassion (together, they have been called compassionate self-responding; CS) is necessarily accompanied by the parallel weakening of the hindrances to self-compassion (or uncompassionate self-responding; UCS). In this view, it does not make sense to have high levels of CS and, at the same time, high levels of Self-judgment that prevents Kindness, Isolation that prevents Common humanity, and Overidentification that prevents Mindfulness. This view characterizes self-compassion as a *unidimensional* construct with two opposite polarities (the metaphor of temperature has been proposed, with the implied cold and warm extremes). In line with this characterization of the self-compassion construct, @neff2022differential strongly advocates the use of the SCS total score (SCS-TS), rather than the CS and UCS separate scores [see also @neff2022self].  -->
...
Latent Profile Analysis (LPA) is a statistical method that aims to identify subgroups or profiles within a population based on their responses to a set of variables of interest. This approach is person-centered and utilizes a model-based framework, which allows for the detection of underlying patterns that may not be apparent through other methods, such as cluster analysis. LPA accounts for measurement errors related to the uncertainty in profile membership and provides fit statistics to determine the number of profiles that best represent the data.

In this study, standardized scores for five personality measures (neuroticism, extraversion, openness, agreeableness, conscientiousness), three dimensions of coping (COPE-active coping, COPE-avoidance coping, COPE-social emotional coping), perceived social support (MSPSS), and post-traumatic stress (measured using the IES-R) from the RWs were used as observed indicators for the LPA. The scores of the were interpreted relative to the sample.

In our study, we employed LPA to identify subgroups or profiles in our RW sample. We fitted a series of LPA models, ranging from 1 to 10 profiles, using 1000 sets of starting values. To determine the optimal number of profiles, we used information criteria, including Bayesian information criterion (BIC), Akaike information criterion (AIC), and adjusted BIC. We selected the model with the lowest value of these criteria, indicating a better fit. Additionally, we evaluated the accuracy of the classification of individuals into the appropriate profile using entropy, with values closer to 1 indicating higher separation among classes (> 0.80 represents high separation). We also employed the Lo-Mendell-Rubin likelihood ratio test (LMR-LRT), a test statistic to compare the fit of a model with a lower versus higher number of profiles. We used MPLUS 8.6 and the `R` software for all statistical analyses.

The purpose of the LPA was to detect distinct groups of RWs who have different personality dimensions, protective factors, and outcome variables.
...
We utilized a Bayesian approach to perform group mean comparisons. This approach enabled us to analyze the raw data without the need for variable transformation, even when the data violated Normality assumptions, by introducing appropriate distributional assumptions. All Bayesian models were implemented using the Stan language with weakly informative priors. To determine a statistically significant group difference, we defined a 95% posterior credibility interval that did not include zero as a credible result.

# Results


## Identification of latent coping profiles for RWs

Table 1 presents fit indices of models with increasing number of coping profiles. 


 | Model | Classes| AIC         |  BIC      |
 | ----- | ------ | ----------- | --------- |
 | 1   |   1    |   21200.556 | 21292.851 |
 | 1   |   2    |   20604.382 | 20747.438 |
 | 1   |   3    |   20323.090 | 20516.908 |
 | 1   |   4    |   20182.173 | 20426.753 |
 | 1   |   5    |   20091.211 | 20386.553 |
 | 1   |   6    |   20022.800 | 20368.904 |
 | 1   |   7    |   19951.032 | 20347.898 |
 | 1   |   8    |   19916.723 | 20364.351 |
 | 1   |   9    |   19837.533 | 20335.923 |
 | 1   |   10   |   19808.314 | 20357.466 |
 | 6   |   1    |   19747.984 | 20047.941 |
 | 6   |   2    |   19380.511 | 19985.040 |
 | 6   |   3    |   19289.640 | 20198.741 |
 | 6   |   4    |   19297.325 | 20510.998 |
 | 6   |   5    |   19234.282 | 20752.526 |
 | 6   |   6    |   19204.350 | 21027.167 |
 | 6   |   7    |   19246.264 | 21373.653 |
 | 6   |   8    |   19269.912 | 21701.872 |
 | 6   |   9    |   19165.055 | 21901.588 |
 | 6   |   10   |   19164.413 | 22205.517 |
 
Note. AIC – Akaike information criterion; BIC – Bayesian information criterion.

An analytic hierarchy process, based on the fit indices AIC, AWE, BIC, CLC, and KIC (Akogul & Erisoglu, 2017), suggests the best solution is Model 6 (varying variances and varying covariances) with 2 classes, entropy = 0.70, minimum and maximum values for the class probabilities in the LPA model were 0.89 and 0.94, respectively. The minimum and maximum numbers of observations required for the LPA model were, respectively, 0.45 and  0.55. The p-value associated with the bootstrapped likelihood ratio test (BLRT), used for LPA models' comparison was 0.00.

The patterns of personality dimensions, protective factors, and outcome that characterize the two RW profiles are shown in Fig. 1. The most numerous first profile contains 54.6% of the participants and can be referred to as the “high resilience” profile. This profile is characterized by a smaller reliance on dysfunctional avoidance-coping strategies, "positive" personality traits (extraversion, agreableness, openness), higher levels of perceived social support, and lower  post-traumatic stress levels. Compared to the other profile, individuals with this profile ("low resilience") 
relied more on dysfunctional avoidance-coping strategies, showed lower levels on the extraversion, agreableness, openness traits, reported lower levels of perceived social support and higher levels of post-traumatic stress. 
